...
if (typeof require !== 'undefined' && typeof module !== 'undefined') {
    if (!global.EnhancedTask) {
        try {
            global.EnhancedTask = require('../models/EnhancedTask');
        } catch (e) {
            // EnhancedTask class akan didefinisikan di scope browser
        }
    }
}
...
class TaskRepository {
    ...
    create(taskData) {
        try {
            const TaskClass = (typeof global !== 'undefined' ? global.EnhancedTask : undefined) || EnhancedTask;
