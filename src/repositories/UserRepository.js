...
// Support both Node.js (testing) dan Browser environments
if (typeof require !== 'undefined' && typeof module !== 'undefined') {
    if (!global.User) {
        try {
            global.User = require('../models/User');
        } catch (e) {
            // User class akan didefinisikan di scope browser
        }
    }
}
...
class UserRepository {
    ...
    create(userData) {
        try {
            ...
            // Buat user baru - support beide Node.js dan Browser
            const UserClass = (typeof global !== 'undefined' ? global.User : undefined) || User;
            const user = new UserClass(userData.username, userData.email, userData.fullName);
